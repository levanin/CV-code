...
#include "Sphere.h"
#include <math.h>
const float EPSILON = 0.01; // Increased our value and made it into a constant variable to fix artifacts with calculations
/**
...
float Sphere::intersect(glm::vec3 p0, glm::vec3 dir)
{
    ...
    if(fabs(delta) < EPSILON) return -1.0; // Altered margin of error here to be epsilon
